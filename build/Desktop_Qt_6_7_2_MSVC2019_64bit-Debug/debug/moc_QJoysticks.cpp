...
#include "../../../QJoysticks/QJoysticks.h"
...
struct qt_meta_stringdata_CLASSQJoysticksENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQJoysticksENDCLASS = QtMocHelpers::stringData(
    "QJoysticks",
    "countChanged",
    "",
    "enabledChanged",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQJoysticksENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QJoysticks::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQJoysticksENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQJoysticksENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQJoysticksENDCLASS_t,
        // property 'count'
...
void QJoysticks::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QJoysticks::countChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QJoysticks::enabledChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QJoysticks::POVEvent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QJoysticks::axisEvent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QJoysticks::buttonEvent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QJoysticks::povChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QJoysticks::axisChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QJoysticks::buttonChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
...
void *QJoysticks::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQJoysticksENDCLASS.stringdata0))
